	...
	public class ProCamera2DRoomsEditor : Editor
	{
...
#if UNITY_5
				EditorGUI.PrefixLabel(new Rect(rect.x, rect.y + 45, 65, 10), new GUIContent("_TurnRateEase Type", ""), EditorStyles.boldLabel);
#else
                    EditorGUI.PrefixLabel(new Rect(rect.x, rect.y + 45, 65, 10), new GUIContent("_TurnRateEase Type", ""));
#endif
				EditorGUI.PropertyField(new Rect(
						rect.x + 80,
						rect.y + 45,
		...
		public override void OnInspectorGUI()
		{
			...
			if (proCamera2DRooms.RestoreOnRoomExit)
			{
				...
				// Restore ease type
				_tooltip = new GUIContent("Restore _TurnRateEase Type", "The ease type of the restore animation");
